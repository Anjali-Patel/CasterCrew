...
public class FeedActivity extends AppCompatActivity {
    ...
    String imageFilePath="",strDescription,strtitle,strEnterLink;
...
//        layoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
        ...
        linear_chooseVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cameradialog = new Dialog(FeedActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                strEnterLink=video_url.getText().toString().trim();
                if(strDescription.equalsIgnoreCase("")){
                    Toast.makeText(FeedActivity.this,"Please enter description",Toast.LENGTH_LONG).show();
                }else if(strtitle.equalsIgnoreCase("")){
                    Toast.makeText(FeedActivity.this,"Please enter Title",Toast.LENGTH_LONG).show();
                } else if(strDescription.length()<150){
                    Toast.makeText(FeedActivity.this,"Minimum length of description should be 150",Toast.LENGTH_LONG).show();
                }else if(imageFilePath.equalsIgnoreCase("")){
                    Toast.makeText(FeedActivity.this,"Please select Image",Toast.LENGTH_LONG).show();
    ...
    public void onActivityResult(int requestcode, int resultcode, Intent data) {
        ...
        if (requestcode == CAMERA) {
            ...
            imageurl = getPath(FeedActivity.this,selectedImageUri).replaceAll(" ","%20");
...
/*
    public class MultipleImagesAdapter extends RecyclerView.Adapter<MultipleImagesAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MultipleImagesAdapter.MyViewHolder holder, final int position) {
            Glide.with(context1).load(*/
/*"file:" +*//*
 MultipleImagesList.get(position)).into(holder.adapterImage);
          */
