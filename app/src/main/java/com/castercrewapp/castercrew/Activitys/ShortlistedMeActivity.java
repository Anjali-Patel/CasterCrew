...
public class ShortlistedMeActivity extends AppCompatActivity {
    LinearLayout other,events,ads,short_film,movies;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shortlisted_me);
        ...
        movies.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(ShortlistedMeActivity.this,NewsPostActivity.class);
