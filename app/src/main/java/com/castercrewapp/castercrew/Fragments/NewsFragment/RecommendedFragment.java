...
public class RecommendedFragment extends Fragment {
    ...
    String User_id;
    RecyclerView RecommendeNewsList;
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    RecommendeNewsList.setLayoutManager(layoutmanager);
                    RecommendeNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecommendeNewsList=view.findViewById(R.id.RecommendeNewsList);
        ...
        RecommendeNewsList.setLayoutManager(linearLayoutManagernews);
        RecommendeNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        RecommendeNewsList.setAdapter(newsAdapter);
