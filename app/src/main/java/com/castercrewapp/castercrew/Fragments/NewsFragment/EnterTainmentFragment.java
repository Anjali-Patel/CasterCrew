...
public class EnterTainmentFragment extends Fragment {
    ...
    String User_id;
    RecyclerView entertainmentNewsList;
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    entertainmentNewsList.setLayoutManager(layoutmanager);
                    entertainmentNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_enter_tainment, container, false);
        ...
        entertainmentNewsList=view.findViewById(R.id.entertainmentNewsList);
        ...
        entertainmentNewsList.setLayoutManager(linearLayoutManagernews);
        entertainmentNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        entertainmentNewsList.setAdapter(newsAdapter);
