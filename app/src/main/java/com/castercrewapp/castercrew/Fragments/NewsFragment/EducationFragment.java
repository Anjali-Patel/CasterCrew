...
public class EducationFragment extends Fragment {
    ...
    String User_id;
    RecyclerView education_newsList;
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    education_newsList.setLayoutManager(layoutmanager);
                    education_newsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        education_newsList=view.findViewById(R.id.education_newsList);
        ...
        education_newsList.setLayoutManager(linearLayoutManagernews);
        education_newsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        education_newsList.setAdapter(newsAdapter);
