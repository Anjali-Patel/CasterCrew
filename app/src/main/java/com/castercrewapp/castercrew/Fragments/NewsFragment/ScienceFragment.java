...
public class ScienceFragment extends Fragment {
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    scienceNewsList.setLayoutManager(layoutmanager);
                    scienceNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scienceNewsList=view.findViewById(R.id.scienceNewsList);
        ...
        scienceNewsList.setLayoutManager(linearLayoutManagernews);
        scienceNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        scienceNewsList.setAdapter(newsAdapter);
