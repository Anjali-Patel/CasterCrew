...
public class PoliticsFragment extends Fragment {
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    politicsNewsList.setLayoutManager(layoutmanager);
                    politicsNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        politicsNewsList=view.findViewById(R.id.politicsNewsList);
        ...
        politicsNewsList.setLayoutManager(linearLayoutManagernews);
        politicsNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        politicsNewsList.setAdapter(newsAdapter);
