 ...
 * {@link CoronavirusFragment.OnFragmentInteractionListener} interface
...
public class CoronavirusFragment extends Fragment {
    ...
    RecyclerView corona_virusNewsList;
   FrameLayout progressBarHolder;
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    corona_virusNewsList.setLayoutManager(layoutmanager);
                    corona_virusNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        corona_virusNewsList=view.findViewById(R.id.corona_virusNewsList);
        ...
        corona_virusNewsList.setLayoutManager(linearLayoutManagernews);
        corona_virusNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        corona_virusNewsList.setAdapter(newsAdapter);
