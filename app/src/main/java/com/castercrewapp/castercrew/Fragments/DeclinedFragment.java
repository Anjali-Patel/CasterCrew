...
public class DeclinedFragment extends Fragment {
    Button declined_by_others,declined_by_me;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        declined_by_others=view.findViewById(R.id.declined_by_others);
        declined_by_me=view.findViewById(R.id.declined_by_me);
        return view;
    }
