...
public class TechFragment extends Fragment {
    ...
    String User_id;
    RecyclerView TechnicalNewsList;
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    TechnicalNewsList.setLayoutManager(layoutmanager);
                    TechnicalNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TechnicalNewsList=view.findViewById(R.id.TechnicalNewsList);
        ...
        TechnicalNewsList.setLayoutManager(linearLayoutManagernews);
        TechnicalNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        TechnicalNewsList.setAdapter(newsAdapter);
