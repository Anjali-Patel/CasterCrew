...
public class TrendingFragment extends Fragment {
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    trendingNewsList.setLayoutManager(layoutmanager);
                    trendingNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        trendingNewsList=view.findViewById(R.id.trendingNewsList);
        ...
        trendingNewsList.setLayoutManager(linearLayoutManagernews);
        trendingNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        trendingNewsList.setAdapter(newsAdapter);
        return view;
    }
