package com.castercrewapp.castercrew.Fragments.VideoFragment;
 ...
 * {@link VideoShortFilmFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link VideoShortFilmFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class VideoShortFilmFragment extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment VideoShortFilmFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static VideoShortFilmFragment newInstance(String param1, String param2) {
        VideoShortFilmFragment fragment = new VideoShortFilmFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_video_short_film, container, false);
...
//                intent.putExtra("AllVideos","All Videos");
        ...
        linear_spatialaudios.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(getActivity(), ContinueWatchingActivity.class);
                intent.putExtra("cc_special_videos_tittle",true);
//                intent.putExtra("CCSpecial ","CC Special Videos");
        ...
        linear_popularaudios.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(getActivity(), ContinueWatchingActivity.class);
                intent.putExtra("recommended_videos_tittle",true);
