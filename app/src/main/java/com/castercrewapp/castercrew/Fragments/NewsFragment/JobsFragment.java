...
public class JobsFragment extends Fragment {
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JobsNewsList.setLayoutManager(layoutmanager);
                    JobsNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        JobsNewsList=view.findViewById(R.id.JobsNewsList);
        ...
        JobsNewsList.setLayoutManager(linearLayoutManagernews);
        JobsNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        JobsNewsList.setAdapter(newsAdapter);
