...
public class TravelFragment extends Fragment {
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    TravelNewsList.setLayoutManager(layoutmanager);
                    TravelNewsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TravelNewsList=view.findViewById(R.id.TravelNewsList);
        ...
        TravelNewsList.setLayoutManager(linearLayoutManagernews);
        TravelNewsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        TravelNewsList.setAdapter(newsAdapter);
