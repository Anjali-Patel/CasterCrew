...
public class CricketFragment extends Fragment {
        ...
        StringRequest jsonRequest = new StringRequest(com.android.volley.Request.Method.GET, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    cricket_newsList.setLayoutManager(layoutmanager);
                    cricket_newsList.setAdapter(newsAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cricket_newsList=view.findViewById(R.id.cricket_newsList);
        ...
        cricket_newsList.setLayoutManager(linearLayoutManagernews);
        cricket_newsList.setHasFixedSize(true);
        newsAdapter = new NewsAdapter(getContext(), newsArrayList,User_id);
        cricket_newsList.setAdapter(newsAdapter);
