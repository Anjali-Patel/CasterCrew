...
public class EliteFragment extends Fragment {
  Button get_invited;
     ...
     * @return A new instance of fragment EliteFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static EliteFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        get_invited=view.findViewById(R.id.get_invited);
        get_invited.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToastMessage.onToast(getContext(),"Thank you for your interest.We will get in touch with you shortly.",ToastMessage.SUCCESS);
