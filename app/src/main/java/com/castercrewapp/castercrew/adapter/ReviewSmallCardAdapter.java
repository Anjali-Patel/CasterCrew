...
public class ReviewSmallCardAdapter extends RecyclerView.Adapter<ReviewSmallCardAdapter.SubCategoryViewHolder>{
String user_id;
    private Context context;
    private OnItemClickListener listener;
    private ArrayList<recent_featured_videos_list> arrayList;
    ViewGroup viewGroup;
    public ReviewSmallCardAdapter(Context context, ArrayList<recent_featured_videos_list> arrayList,String user_id) {
    ...
    @NonNull
    @Override
    public ReviewSmallCardAdapter.SubCategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
        View view = LayoutInflater.from(context)
                .inflate(R.layout.small_reviewcard_list_layout, parent, false);
        return new ReviewSmallCardAdapter.SubCategoryViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ReviewSmallCardAdapter.SubCategoryViewHolder holder, int position) {
