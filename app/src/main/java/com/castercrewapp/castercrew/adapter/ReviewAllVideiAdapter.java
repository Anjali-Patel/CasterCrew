...
public class ReviewAllVideiAdapter extends RecyclerView.Adapter<ReviewAllVideiAdapter.SubCategoryViewHolder>{
private String user_id;
    ...
    public ReviewAllVideiAdapter(Context context, ArrayList<recent_featured_videos_list> arrayList,String user_id) {
    ...
    @NonNull
    @Override
    public ReviewAllVideiAdapter.SubCategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
        View view = LayoutInflater.from(context)
                .inflate(R.layout.review_subcategory_layout, parent, false);
        return new ReviewAllVideiAdapter.SubCategoryViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull ReviewAllVideiAdapter.SubCategoryViewHolder holder, int position) {
