...
public class HorizontalAuditionAdapter extends RecyclerView.Adapter<HorizontalAuditionAdapter.SubCategoryViewHolder>{
    private Context context;
    private OnItemClickListener listener;
    private ArrayList<recent_featured_videos_list> arrayList;
String user_id;
    ViewGroup viewGroup;
    public HorizontalAuditionAdapter(OnItemClickListener listener, ArrayList<recent_featured_videos_list> arrayList,String user_id) {
    ...
    @NonNull
    @Override
    public HorizontalAuditionAdapter.SubCategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
        View view = LayoutInflater.from(context)
                .inflate(R.layout.reviews_list_layout, parent, false);
        return new HorizontalAuditionAdapter.SubCategoryViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HorizontalAuditionAdapter.SubCategoryViewHolder holder, int position) {
   ...
   holder.download.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        if(user_id.equalsIgnoreCase("")){
            ...
            Toast.makeText(context,"Downloading Audition Detail......",Toast.LENGTH_LONG).show();
