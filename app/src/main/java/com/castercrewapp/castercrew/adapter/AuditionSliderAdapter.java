...
public class AuditionSliderAdapter extends PagerAdapter {

    private ArrayList<Integer> images;
    private LayoutInflater inflater;
    private Context context;

    public AuditionSliderAdapter(Context context, ArrayList<Integer> images) {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        View myImageLayout = (View) inflater.inflate(R.layout.auditionslider_detail_layout ,view, false);
