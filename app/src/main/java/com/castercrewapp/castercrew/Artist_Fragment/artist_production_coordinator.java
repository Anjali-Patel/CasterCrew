...
public class artist_production_coordinator extends Fragment implements OnItemClickListener {
    String user_id;
    ...
    public void getlist(){
        ...
        Call<List<recent_featured_profile_list>> call = apiService.getartist_produ_coordinator("Artists","Production Coordinator");
