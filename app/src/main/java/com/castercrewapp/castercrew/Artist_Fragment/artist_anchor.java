...
public class artist_anchor extends Fragment implements OnItemClickListener {
    String user_id;
    ...
    public void getlist(){
        ...
        Call<List<recent_featured_profile_list>> call = apiService.getartist_anchor("Artists","Anchor");
