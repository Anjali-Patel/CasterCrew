...
public class artist_model extends Fragment implements OnItemClickListener {
    String user_id;
    ...
    public void getlist(){
        ...
        Call<List<recent_featured_profile_list>> call = apiService.getartist_model("Artists","Model");
